...
You should follow the instructions on the download page for installing Neo4j Desktop.
...
. You must specify a password that you should remember as it may be required for clients connecting to the DBMS. Neo4j Browser started from Neo4j Desktop automatically uses this password, but other clients may need the user name of neo4j and the password you specify here to connect.
